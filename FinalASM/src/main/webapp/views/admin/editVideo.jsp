...
<html lang="en">
   <head>
      ...
      <!-- Favicon -->
      <link rel="shortcut icon" href="<c:url value='/templates/admin/images/favicon.ico'/>">
      <!-- Bootstrap CSS -->
      <link rel="stylesheet" href="<c:url value='/templates/admin/css/bootstrap.min.css'/>">
      <!-- Typography CSS -->
      <link rel="stylesheet" href="<c:url value='/templates/admin/css/typography.css'/>">
      <!-- Style CSS -->
      <link rel="stylesheet" href="<c:url value='/templates/admin/css/style.css'/>">
      <!-- Responsive CSS -->
      <link rel="stylesheet" href="<c:url value='/templates/admin/css/responsive.css'/>">
   </head>
   <body>
     ...
     <form action="Video/edit" method="get">
  <div class="form-group">
    <label>Tiêu Đề</label>
    <input name="title" type="text" class="form-control"  placeholder="Đặt tiêu đề">
  </div>
   <div class="form-group">
    <label>Link</label>
    <input name="href" type="text" class="form-control"  placeholder="Href">
  </div>
  <div class="form-group">
    <label >Poster</label>
    <input name="poster" type="text" class="form-control"  placeholder="Poster">
  </div>
    <div class="form-group">
  ...
  <button formaction="Video/create" type="submit" class="btn btn-primary">Create</button>
  ...
  ${message}
                           ...
                           <div id="table" class="table-editable">
							...
							<br> 
								...
								<h6>Video được yêu thích</h6>
					
					
					<form action="Video/like" method="get">		
					<div class="card-body">
							...
							<br>
                       	  ...
                       	  <table class="table table-bordered table-responsive-md table-striped text-center">
                                 ...
                                 <tbody>
									<c:forEach items="${videos}" var="item1">
										<tr>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-lg-6 text-right">
                  Copyright 2023 <a href="https://www.facebook.com/kunNnN161203/">Phạm Thái</a>.
               </div>
            </div>
         </div>
      </footer>
      ...
      <script src="<c:url value='templates/admin/js/jquery.counterup.min.js'/>"></script>
      <!-- Wow JavaScript -->
      ...
      <script src="<c:url value='templates/admin/js/jquery.magnific-popup.min.js'/>"></script>
